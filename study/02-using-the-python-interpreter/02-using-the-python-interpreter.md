# 2. Python 解释器[¶](https://docs.python.org/zh-cn/3/tutorial/interpreter.html#using-the-python-interpreter)
...
- [1](https://docs.python.org/zh-cn/3/tutorial/interpreter.html#id1)
